...
const messageBaseHtml = `<div class="flex p-3 text-sm rounded-lg mx-auto w-5/6 max-w-lg break-all" role="alert">
...
class Message {
  ...
  constructor(message: string, styleInfo: IMessageCss) {
    ...
    msgWrapper.className =
      "relative z-40 mt-4 w-full ease-out duration-300 transition-all max-h-full";
